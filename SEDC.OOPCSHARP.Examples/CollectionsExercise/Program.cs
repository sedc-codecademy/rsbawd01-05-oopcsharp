using CollectionsExercises.Classes;
...
namespace CollectionsExercise
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Jane.FavoriteSongs = Songs.Where(x => x.Genre == Genre.Rock)
                .ToList();
            ...
            var peopleWithFourOrMoreSongs = FansArray
                .Where(fan => fan.FavoriteSongs.Count() >= 4)
                .ToList();
        ...
        static void PrintPhone(Dictionary<string, long> phoneBook, string name)
        {
