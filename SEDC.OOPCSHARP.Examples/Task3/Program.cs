...
namespace Task3
{
    internal class Program
    {
        ...
        private static void Login(User[] users, string username, string password)
        {
        ...
        private static void Register(User[] users, string username, string password, int id)
        {
            User user = FindUser(users, username, password);
        ...
        private static bool UsersUI(User[] users)
        {
